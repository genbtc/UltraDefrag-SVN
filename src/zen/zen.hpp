...
//these debug symbols conflict with Boost primitives or something:
}
...
public:
  ...
  explicit GapEnumeration(char volume)
...
public:
  ...
  FileEnumeration() = delete;
  explicit FileEnumeration(char volume, ftw_progress_callback cb = nullptr,
                  void *ud = nullptr)
